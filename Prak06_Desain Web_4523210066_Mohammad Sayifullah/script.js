const apiKey = 'da80d29fcc5c43a892b50743241510';  // API key yang Anda dapatkan
const city = 'Depok';
const cityJudul = document.getElementById('city-judul');
cityJudul.textContent = `Cuaca di ${city}`;
const cityTitle = document.getElementById('city-title');
cityTitle.textContent = `Cuaca ${city} dengan WeatherAPI`;
